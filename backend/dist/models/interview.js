...
const interviewSchema = new mongoose_1.Schema({
    ...
    packages: [{ type: mongoose_1.Schema.Types.ObjectId, ref: 'QuestionPackage', required: true }], // Referencing Question Packages
    userId: [{ type: mongoose_1.Schema.Types.ObjectId, ref: 'User' }], // User referansı ekleyin
